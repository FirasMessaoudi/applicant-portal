...
public class UserServiceTest {
    ...
    public void test_update_applicant_by_uin() throws WsAuthenticationException {
        UpdateApplicantCmd applicant = new UpdateApplicantCmd(String.valueOf(TEST_UIN), TEST_EMAIL, TEST_MOBILE, TEST_COUNTRY_CODE, new Date(), TEST_DATE_OG_BIRTH_HIGRI, EChannel.WEB.name());
        ApplicantLiteDto applicantLiteDto = new ApplicantLiteDto();
