...
export class AuthenticationService {
   ...
   */
  login(username: string, password: string, recaptchaToken: string, loginType:string, nationality: any): Observable<any> {
    console.log(loginType);
    let params: String = recaptchaToken ? '?grt=' + recaptchaToken : '';

    return this.http.post<any>('/core/api/auth/login' + params, {'type': loginType, 'idNumber': username, 'password': password, 'nationalityCode':nationality});
  }
