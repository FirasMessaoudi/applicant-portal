...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] PUBLIC_URLS = {"/api/ws/auth", "/api/ws/auth/auth", "/api/ws/users/country/list", "/api/ws/auth/login", "/api/ws/auth/otp", "/api/ws/register/**", "/api/ws/users/reset-password", "/api/auth/login", "/api/auth/otp", "/api/users/reset-password", "/api/lookup/language/list", "/api/users/language/**",
