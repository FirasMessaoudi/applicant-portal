...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] PUBLIC_URLS = {"/api/auth/login", "/api/auth/otp", "/api/users/reset-password", "/api/users/contacts", "/api/register", "/api/register/otp/validate", "/api/register/otp", "/api/register/verify", "/index.html", "/error", "/api-docs", "/swagger-ui.html", "/swagger-ui/**"};
