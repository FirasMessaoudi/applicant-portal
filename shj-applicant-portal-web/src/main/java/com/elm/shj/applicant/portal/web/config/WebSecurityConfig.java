...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] PUBLIC_URLS = {"/api/ws/auth", "/api/ws/register/**", "/api/auth/login", "/api/auth/otp", "/api/users/reset-password",
            "/api/register", "/api/register/otp", "/api/register/verify", "/api/lookup/country/list", "/index.html", "/error", "/api-docs", "/swagger-ui.html", "/swagger-ui/**"};
